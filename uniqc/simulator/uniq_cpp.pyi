...
class DensityOperatorSimulator:
    ...
    def cswap(
        self, controller: int, target1: int, target2: int, global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
    ...
    def rphi(
        self, qn: int, theta: float, phi: float, global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
    ...
    def toffoli(
        self, controller1: int, controller2: int, target: int, global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
    ...
    def u2(
        self, qn: int, phi: float, lamda: float, global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
    def u22(
        self, qn: int, unitary: list[complex[4]], global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
    def u3(
        self, qn: int, theta: float, phi: float, lamda: float, global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
    def uu15(
        self, qn1: int, qn2: int, parameters: list[float], global_controller: list[int] = [], dagger: bool = False
    ) -> None: ...
