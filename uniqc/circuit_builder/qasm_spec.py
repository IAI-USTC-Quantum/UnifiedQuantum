...
available_qasm_1q1p_gates = ["rx", "ry", "rz", "u1", "p"]
available_qasm_1q2p_gates = ["u2", "rphi"]
available_qasm_1q3p_gates = ["u3", "u"]
available_qasm_2q_gates = ["cx", "cy", "cz", "swap", "iswap"]
available_qasm_3q_gates = ["ccx", "cswap"]
available_qasm_4q_gates = ["c3x"]
available_qasm_2q1p_gates = ["crx", "cry", "crz", "cu1", "rxx", "ryy", "rzz", "xy"]
available_qasm_2q3p_gates = ["phase2q", "cu3"]
available_qasm_2q15p_gates = ["uu15"]
...
available_qasm_gates.update({gatename: {"qubit": 2, "params": 3} for gatename in available_qasm_2q3p_gates})
available_qasm_gates.update({gatename: {"qubit": 2, "params": 15} for gatename in available_qasm_2q15p_gates})
