...
Comprehensive unit tests for:
  - uniqc/circuit_builder/opcode.py
  - uniqc/circuit_builder/translate_qasm2_oir.py
  - uniqc/circuit_builder/random_qasm.py
  - uniqc/circuit_builder/random_originir.py
"""

import pytest
from uniqc.circuit_builder.opcode import (
...
from uniqc.circuit_builder.random_qasm import (
    build_qasm_gate,
...
from uniqc.circuit_builder.random_originir import (
    build_originir_gate,
...
class TestOpcodeToLineOriginirEdgeCases:
    ...
    def test_empty_operation_raises_runtimeerror(self):
        ...
        from uniqc.circuit_builder.opcode import opcode_to_line_originir
...
class TestTranslateQasm2OirErrorPaths:
    ...
    def test_direct_mapping_returns_none_for_unmapped(self):
        ...
        from uniqc.circuit_builder.translate_qasm2_oir import direct_mapping_qasm2_to_oir
