...
from uniqc.compile.timeline import create_time_line_table, format_result, plot_time_line
...
def run_test_format_result():
    ...
    pulse_rphi90 = json.dumps([{"RPhi": [0, 45.0, 90.0, 0]}, {"RPhi": [1, 90.0, 90.0, 10]}])
