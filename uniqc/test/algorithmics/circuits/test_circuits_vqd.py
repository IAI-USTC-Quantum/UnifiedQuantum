...
class TestVQDCircuit:
    ...
    def test_vqd_circuit_nonempty(self):
        ...
        c = vqd_circuit(2, ansatz_params=[0.1, 0.2, 0.3, 0.4], prev_states=[gs], qubits=[0, 1], n_layers=2)
    ...
    def test_vqd_different_param_counts(self):
        ...
        c1 = vqd_circuit(2, ansatz_params=[0.1, 0.2], prev_states=[gs], qubits=[0, 1], n_layers=1)
        assert len(c1.opcode_list) > 0

        # 2 qubits, 3 layers = 6 params
        c2 = vqd_circuit(2, ansatz_params=[0.1] * 6, prev_states=[gs], qubits=[0, 1], n_layers=3)
    ...
    def test_vqd_wrong_param_count_raises(self):
        ...
        with pytest.raises(ValueError, match="Expected"):
            vqd_circuit(2, ansatz_params=[0.1], prev_states=[gs], qubits=[0, 1], n_layers=2)
    ...
    def test_vqd_empty_prev_states_raises(self):
        ...
        with pytest.raises(ValueError, match="VQE"):
            vqd_circuit(2, ansatz_params=[0.1, 0.2, 0.3, 0.4], prev_states=[], qubits=[0, 1], n_layers=2)
