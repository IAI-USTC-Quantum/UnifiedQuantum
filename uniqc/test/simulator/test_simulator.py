...
def test_noisy_simulator():
    ...
    error_loader = ErrorLoader_GateSpecificError(
        generic_noise_description, gatetype_description, gate_specified_noise_description
    )

    print(error_loader)

    # Create an instance of the NoisySimulator
    simulator = NoisySimulator(backend_type="statevector", error_loader=error_loader, readout_error=readout_error)
...
def test_noisy_simulator_2():
    ...
    # Create an instance of the NoisySimulator
    simulator = NoisySimulator(backend_type="density_matrix", error_loader=error_loader, readout_error=readout_error)
