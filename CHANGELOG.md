...
and fixes empty OriginQ hardware task results (GitHub issue #119).
Validation is documented in ``docs/source/7_releases/reports/0.0.17.post1.md``.
...
task lifecycle persistence, WebSocket cleanup, and packaging. Release-candidate
validation is documented in ``docs/source/7_releases/reports/0.0.17.md``.
