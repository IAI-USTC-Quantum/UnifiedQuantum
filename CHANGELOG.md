...
- **Dummy workflow guidance**: `dummy=True` remains deprecated. Documentation and examples now prefer explicit backend ids: `dummy`, `dummy:virtual-line-3`, `dummy:virtual-grid-2x2`, and `dummy:originq:WK_C180`.
