...
== dummy:local:mps-linear-32 backend (chi=8, forces truncation) ==
  result: UnifiedResult(counts={'00000000000000000000000000000000': 199, '11111111111111111111111111111111': 201}, probabilities={'00000000000000000000000000000000': 0.4975, '11111111111111111111111111111111': 0.5025}, shots=400, platform='dummy', task_id='uqt_4246f51407a94fd585d223cc42a034b8', backend_name='dummy:local:mps-linear-32:chi=8:cutoff=1e-10', execution_time=None, error_message=None)
