...
== dummy:local:mps-linear-32 backend (chi=8, forces truncation) ==
  result: UnifiedResult(counts={'11111111111111111111111111111111': 190, '00000000000000000000000000000000': 210}, probabilities={'11111111111111111111111111111111': 0.475, '00000000000000000000000000000000': 0.525}, shots=400, platform='dummy', task_id='uqt_a9b9b0f14c2146e184c488d3cf187a67', backend_name='dummy:local:mps-linear-32:chi=8:cutoff=1e-10', execution_time=None, error_message=None)
