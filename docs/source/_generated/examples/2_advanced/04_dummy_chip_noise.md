...
== dummy:local:simulator ==
  ...
  counts:          UnifiedResult(counts={'000': 128, '111': 128}, probabilities={'000': 0.5, '111': 0.5}, shots=256, platform='dummy', task_id='uqt_4b2006d493de4e0eb31b15f034db5c08', backend_name='dummy:local:simulator', execution_time=None, error_message=None)
== dummy:local:virtual-line-3 ==
  description:     Noiseless virtual 3-qubit line topology
  topology:        [[0, 1], [1, 2]]
  simulator_kwargs: None
  counts:          UnifiedResult(counts={'000': 128, '111': 128}, probabilities={'000': 0.5, '111': 0.5}, shots=256, platform='dummy', task_id='uqt_6bbd5dbf39ed405194120e77ff2f9af2', backend_name='dummy:local:virtual-line-3', execution_time=None, error_message=None)
== dummy:local:mps-linear-3:chi=8 ==
  ...
  counts:          UnifiedResult(counts={'000': 119, '111': 137}, probabilities={'000': 0.46484375, '111': 0.53515625}, shots=256, platform='dummy', task_id='uqt_e8e42ff6a0ad48d7b3500107173fb882', backend_name='dummy:local:mps-linear-3:chi=8', execution_time=None, error_message=None)
```
